...
public class AttractionDetailsFragment extends Fragment {
    ...
    public int mAttractionWebsitesArrayLen = 0;
    public WebView webView = null;
    public static final String TAG = "AttractionDetailsFragment";

    public void showDetailsAtIndex(int newIndex){
//        Log.i(TAG, "showDetailsAtIndex");
        if(newIndex < 0 || newIndex >= mAttractionWebsitesArrayLen)
            return;
        currentIdx = newIndex;
        webView.loadUrl(AttractionsActivity.attractionWebsitesArray[currentIdx]);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.attractions_details_fragment, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        webView = getActivity().findViewById(R.id.attraction_details_webview);
        webView.getSettings().setJavaScriptEnabled(true); //To play YouTube videos
        webView.setWebViewClient(new WebViewClient(){});

        mAttractionWebsitesArrayLen = AttractionsActivity.attractionWebsitesArray.length;
